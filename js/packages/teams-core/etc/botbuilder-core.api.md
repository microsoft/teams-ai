...
import { AdaptiveCardInvokeResponse } from '@microsoft/teams-connector/src/schema';
import { AdaptiveCardInvokeValue } from '@microsoft/teams-connector/src/schema';
import { AnimationCard } from '@microsoft/teams-connector/src/schema';
import { Attachment } from '@microsoft/teams-connector/src/schema';
import { AudioCard } from '@microsoft/teams-connector/src/schema';
import { AuthenticateRequestResult } from '@microsoft/teams-connector';
import { AuthenticationConfiguration } from '@microsoft/teams-connector';
import { BotFrameworkAuthentication } from '@microsoft/teams-connector';
import { BotFrameworkClient } from '@microsoft/teams-connector';
import { CardAction } from '@microsoft/teams-connector/src/schema';
import { CardImage } from '@microsoft/teams-connector/src/schema';
import { ChannelAccount } from '@microsoft/teams-connector/src/schema';
import { ClaimsIdentity } from '@microsoft/teams-connector';
import { Configuration } from 'botbuilder-dialogs-adaptive-runtime-core';
import { ConnectorClientOptions } from '@microsoft/teams-connector';
import { ConnectorFactory } from '@microsoft/teams-connector';
import { ConversationParameters } from '@microsoft/teams-connector/src/schema';
import { ConversationReference } from '@microsoft/teams-connector/src/schema';
import { HeroCard } from '@microsoft/teams-connector/src/schema';
import { InputHints } from '@microsoft/teams-connector/src/schema';
import { InvokeResponse } from '@microsoft/teams-connector/src/schema';
import { MediaUrl } from '@microsoft/teams-connector/src/schema';
import { Mention } from '@microsoft/teams-connector/src/schema';
import { MessageReaction } from '@microsoft/teams-connector/src/schema';
import { O365ConnectorCard } from '@microsoft/teams-connector/src/schema';
import { PasswordServiceClientCredentialFactory } from '@microsoft/teams-connector';
import { ReceiptCard } from '@microsoft/teams-connector/src/schema';
import { ResourceResponse } from '@microsoft/teams-connector/src/schema';
import { SearchInvokeResponse } from '@microsoft/teams-connector/src/schema';
import { SearchInvokeValue } from '@microsoft/teams-connector/src/schema';
import { ServiceClientCredentials } from '@microsoft/teams-connector';
import { ServiceClientCredentialsFactory } from '@microsoft/teams-connector';
import { ServiceCollection } from 'botbuilder-dialogs-adaptive-runtime-core';
import { SignInUrlResponse } from '@microsoft/teams-connector/src/schema';
import { StatusCodes } from '@microsoft/teams-connector/src/schema';
import { ThumbnailCard } from '@microsoft/teams-connector/src/schema';
import { TokenExchangeRequest } from '@microsoft/teams-connector/src/schema';
import { TokenExchangeResource } from '@microsoft/teams-connector/src/schema';
import { TokenPostResource } from '@microsoft/teams-connector/src/schema';
import { TokenResponse } from '@microsoft/teams-connector/src/schema';
import { UserTokenClient } from '@microsoft/teams-connector';
import { VideoCard } from '@microsoft/teams-connector/src/schema';
