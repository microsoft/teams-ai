...
To build the packages and samples do the following from the root `js` directory:
...
`cd` into the sample directory to see more instructions.

1. Follow the Teams Toolkit setup instructions.
