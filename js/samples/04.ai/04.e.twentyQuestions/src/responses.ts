...
export function pickSecretWord(): string {
    return getRandomResponse([
        ...
        'Horse', 'Butterfly', 'Stadium', 'Frog', 'Cheetah', 'Castle', 'Crocodile', 
        'Island', 'Swimming Pool', 'Wolf', 'Plane', 'Beach', 'Beaver', 'Bridge', 
        'Balloon', 'Diamond', 'Cheese', 'Train', 'Dog', 'Beetle', 'Candy', 
        'Swan', 'House', 'Tiger', 'Hippo', 'Tank', 'Owl', 'Shark', 'Key', 
        'Gorilla', 'Fighter Jet', 'Printer', 'Dragon', 'Snake', 'Submarine', 
        'Stars', 'Hummingbird', 'Pumpkin', 'Lighthouse', 'Telescope', 'Boat', 
        'Spider', 'Cake', 'Cave', 'Garden', 'Subway', 'Deer', 'Skyscraper', 'Jaguar', 
        'Whale', 'Motorcycle', 'Desk', 'Ostrich', 'Fox', 'Bicycle', 
        'Panda', 'Couch', 'Ladybug', 'Fire Truck', 'Ant', 'Tortoise', 'Robot', 
        'Rocket', 'Bison', 'Guitar', 'Comet', 'Train Station', 'Pen', 'Pig', 
        'Geyser', 'Ship', 'Scorpion', 'Lobster', 'Satellite', 'Coral Reef', 'Jellyfish', 
        'Pigeon', 'Racoon', 'Umbrella', 'Octopus', 'Lamb', 'Store', 'Chipmunk', 
        'Fountain', 'Porcupine', 'Seagull', 'Bear', 'Hedgehog', 'Chessboard', 
        'Coastline', 'Puppet', 'Flower', 'Bull', 'Computer', 'Tesla', 'Sloth', 
        'Ice Cream', 'Rattlesnake', 'Honeybee', 'Yacht', 'Boogeyman', 'Ferris Wheel', 
        'Goblin', 'Rhino', 'Fairy', 'Roller Coaster', 'Toucan', 'Rainbow', 'Rock', 
        'Phone', 'Triangle', 'Swamp', 'Housefly', 'Table', 'Hamster', 'Salmon', 'Zebra', 
        'Carrot', 'Cobra', 'Bush', 'Lamp', 'Banana Split', 'Coffee Pot', 
        'Homeless Man', 'Monkey', 'Compass', 'Hedge Maze', 'Unicorn', 'Beehive', 'Goldfish', 
        'Caterpillar', 'Matches', 'Skateboard', 'Big Ben', 'Vacuum', 'Buffalo', 'Goose', 
        'UFO', 'Peacock Feather', 'Squirrel', 'Kangaroo', 'Soccer Ball', 'Lawn Mower', 
        'Polaroid Camera', 'Bowling Alley', 'Flashlight', 'Pirate Ship', 'Microsoft', 'Fly', 'Ferret', 
        'Gardner', 'Lava Lamp', 'Cathedral', 'Priest', 'Wizard', 'Lizard', 
        'Chef', 'Gnome', 'Witch', 'Bat', 'Meteor', 'Honey Pot', 'Kite', 'Pistol', 'Dolphin', 
        'Doctor', 'Helicopter', 'Bumblebee', 'Tuna', 'Boxer', 'Superhero', 
        'Party Hat', 'Piano', 'Penguin', 'Fire Hydrant', 'Leprechaun', 'Cherry', 
        'Paris', 'Mermaid', 'Library', 'Campfire', 'Hockey', 'Laser', 'Grasshopper', 
        'Volleyball', 'Fish', 'Rabbit', 'Spider Web', 'Skull', 'Apple Pie', 'Beans', 
        'Teapot', 'Museum', 'Lemon', 'Chair', 'T-Rex', 'Space Needle', 'Tombstone', 
        'Garbage Truck', 'Tricycle', 'Ray Gun', 'Washington', 'Anchor', 'Football', 
        'Lipstick', 'Seattle', 'Flamingo', 'Mummy', 'Black Hole', 'Roam', 
        'Fog', 'Vampire', 'Strawberry', 'Angel', 'Parachute', 'Coliseum'
    ]);
}
