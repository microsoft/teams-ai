...
namespace QuestBot
{
    public class TeamsQuestBot : Application<QuestState, QuestStateManager>
    {
        ...
        protected override async Task<bool> OnBeforeTurnAsync(ITurnContext turnContext, QuestState turnState, CancellationToken cancellationToken)
        {
            ...
            if (!conversation.Greeted)
            {
                ...
                // Create campaign
                var response = await AI.CompletePromptAsync(turnContext, turnState, "CreateCampaign", null, cancellationToken);
        ...
        protected override async Task<bool> OnAfterTurnAsync(ITurnContext turnContext, QuestState turnState, CancellationToken cancellationToken)
        {
        ...
        protected override async Task OnMessageActivityAsync(ITurnContext<IMessageActivity> turnContext, QuestState turnState, CancellationToken cancellationToken)
        {
            ...
            else
            {
                ...
                await AI.ChainAsync(turnContext, turnState, prompt, cancellationToken: cancellationToken);
            }
        }
