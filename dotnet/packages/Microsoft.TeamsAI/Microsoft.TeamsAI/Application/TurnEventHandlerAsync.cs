...
namespace Microsoft.Teams.AI
{
    ...
    public delegate Task<bool> TurnEventHandlerAsync<TState>(ITurnContext turnContext, TState turnState, CancellationToken cancellationToken) where TState : ITurnState<Record, Record, TempState>;
}
