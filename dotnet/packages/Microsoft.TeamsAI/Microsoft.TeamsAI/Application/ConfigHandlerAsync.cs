...
namespace Microsoft.Teams.AI
{
    ...
    public delegate Task<ConfigResponseBase> ConfigHandlerAsync<TState>(ITurnContext turnContext, TState turnState, object configData, CancellationToken cancellationToken) where TState : ITurnState<Record, Record, TempState>;
}
