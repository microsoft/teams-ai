...
namespace Microsoft.Teams.AI
{
    ...
    public delegate Task<bool> TurnEventHandler<TState>(ITurnContext turnContext, TState turnState, CancellationToken cancellationToken) where TState : ITurnState<Record, Record, TempState>;
}
