...
namespace Microsoft.Teams.AI
{
    ...
    /// <returns></returns>
    public delegate Task ReadReceiptHandler<TState>(ITurnContext turnContext, TState turnState, ReadReceiptInfo data, CancellationToken cancellationToken) where TState : ITurnState<Record, Record, TempState>;
}
