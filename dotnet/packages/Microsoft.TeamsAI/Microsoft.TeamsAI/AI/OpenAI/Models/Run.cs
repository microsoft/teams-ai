...
namespace Microsoft.Teams.AI.AI.OpenAI.Models
{
    internal class Run
    {
        ...
        public ThreadRun ToThreadRun()
        {
            return ModelReaderWriter.Read<ThreadRun>(BinaryData.FromObjectAsJson(this))!;
        }
    }
    ...
    internal class SubmitToolOutputsParams
    {
        ...
        public IList<Azure.AI.OpenAI.Assistants.ToolOutput> ToToolOutputs()
        {
            List<Azure.AI.OpenAI.Assistants.ToolOutput> toolOutputs = new();
            foreach (ToolOutput toolOutput in ToolOutputs)
            {
                Azure.AI.OpenAI.Assistants.ToolOutput? newToolOutput = toolOutput.ToToolOutput();
                if (newToolOutput == null)
                {
                    continue;
                }
                toolOutputs.Add(newToolOutput);
            }
            return toolOutputs;
        }
    }
    ...
    internal class ToolOutput
    {
        ...
        public Azure.AI.OpenAI.Assistants.ToolOutput ToToolOutput()
        {
            return ModelReaderWriter.Read<Azure.AI.OpenAI.Assistants.ToolOutput>(BinaryData.FromObjectAsJson(this))!;
        }
    }
}
