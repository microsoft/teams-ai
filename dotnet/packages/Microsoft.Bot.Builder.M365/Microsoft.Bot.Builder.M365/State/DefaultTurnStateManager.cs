...
namespace Microsoft.Bot.Builder.M365.State
{
        ...
        where TTempState : TempState, new()
    {
        ...
        public async Task<TDefaultTurnState> LoadStateAsync(IStorage? storage, TurnContext turnContext)
        {
            // Compute state keys
        ...
        public async Task SaveStateAsync(IStorage? storage, TurnContext turnContext, TDefaultTurnState turnState)
        {
