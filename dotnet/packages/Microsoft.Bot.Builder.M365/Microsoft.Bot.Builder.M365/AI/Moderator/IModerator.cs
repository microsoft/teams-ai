...
namespace Microsoft.Bot.Builder.M365.AI.Moderator
{
    ...
    public interface IModerator<TState> where TState : TurnState
    {
        ...
        Task<Plan?> ReviewPrompt(TurnContext turnContext, TState turnState, PromptTemplate prompt);
        ...
        Task<Plan?> ReviewPlan(TurnContext turnContext, TState turnState, Plan plan);
    }
}