...
const { TeamsSharedChannelEvents } = require('./agents/teamsSharedChannelEvents');
...
// Create the agent instance responsible for handling incoming messages.
const agent = new TeamsSharedChannelEvents();
