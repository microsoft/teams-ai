...
1. **Citations** - This is a feature that displays citations provided by the AI system when using a datasource like Azure OpenAI On Your Data. This can be used to provide sources for the information the AI system provides.
1. **Sensitivity information** - This is a feature that displays sensitivity information on citations provided by the AI system when using a datasource like Azure OpenAI On Your Data. This can be used to inform the user that the information provided may be sensitive and whether or not it can be shared outside of your organization.
...
Citations are a feature that can be used to provide sources for the information the AI system provides. This can be from digital documents the LLM references, like when using a datasource like Azure OpenAI On Your Data. To see citations in action, please check out the Azure OpenAI datasources sample(s).
