...
class SsoOptions(DataClassJsonMixin):
    ...
    sign_in_link: str
    # Library passes `scope`, `client_id`, and `tenant_id`
    # as query params to compose the AAD sign-in URL.

    timeout: int = 900000
    # Number of ms to wait for the user to auth. Default 15 mins.
    # Only in conversational bot scenario.
