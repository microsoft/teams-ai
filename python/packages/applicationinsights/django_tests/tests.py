...
from teams.applicationinsights.django import common
...
@modify_settings(
    **{
        MIDDLEWARE_NAME: {
            "append": "teams.applicationinsights.django.ApplicationInsightsMiddleware",
            "prepend": "teams.applicationinsights.django.BotTelemetryMiddleware",
        }
    }
)
@override_settings(
...
@override_settings(
    LOGGING={
        ...
        "handlers": {
            "appinsights": {
                "class": "teams.applicationinsights.django.LoggingHandler",
                "level": "INFO",
            }
        },
