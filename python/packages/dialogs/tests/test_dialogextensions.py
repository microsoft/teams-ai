...
from teams.connector.auth import ClaimsIdentity, AuthenticationConstants
...
from teams.core.adapters import (
    TestFlow,
    TestAdapter,
)
from teams.core.skills import (
    SkillHandler,
    SkillConversationReference,
)
from teams.core.transcript_logger import (
    TranscriptLoggerMiddleware,
    ConsoleTranscriptLogger,
)
from teams.schema import ActivityTypes, Activity, EndOfConversationCodes
