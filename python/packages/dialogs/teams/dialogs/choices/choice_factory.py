...
class ChoiceFactory:
    ...
    def inline(
        ...
        return MessageFactory.text("".join(txt_builder), speak, InputHints.expecting_input)
    ...
    @staticmethod
    def suggested_action(choices: List[Choice], text: str = None, speak: str = None) -> Activity:
        """
