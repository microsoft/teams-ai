...
class ComponentDialog(Dialog):
    """
    A :class:`teams.dialogs.Dialog` that is composed of other dialogs
    ...
    async def begin_dialog(
        ...
        :param dialog_context: The :class:`teams.dialogs.DialogContext` for the current turn of the conversation.
        :type dialog_context: :class:`teams.dialogs.DialogContext`
    ...
    async def continue_dialog(self, dialog_context: DialogContext) -> DialogTurnResult:
        ...
        .. remarks::
            ...
            :meth:`teams.dialogs.DialogContext.continue_dialog` method on it's inner dialog
            context. If the inner dialog stack is empty, the component dialog ends,
            and if a :class:`teams.dialogs.DialogTurnResult.result` is available, the component dialog
    ...
    async def resume_dialog(
        ...
        :type reason: :class:`teams.dialogs.DialogReason`
    ...
    async def reprompt_dialog(self, context: TurnContext, instance: DialogInstance) -> None:
        ...
        :type instance: :class:`teams.dialogs.DialogInstance`
        """
    ...
    async def find_dialog(self, dialog_id: str) -> Dialog:
        ...
        :rtype: :class:`teams.dialogs.Dialog`
        """
    ...
    async def on_begin_dialog(self, inner_dc: DialogContext, options: object) -> DialogTurnResult:
        ...
        .. remarks::
            ...
            By default, this calls the :meth:`teams.dialogs.Dialog.begin_dialog()`
        ...
        :type inner_dc: :class:`teams.dialogs.DialogContext`
        :param options: Optional, initial information to pass to the dialog.
        :type options: object
        """
    ...
    async def end_component(
        ...
        :type outer_dc: class:`teams.dialogs.DialogContext`
        :param result: Optional, value to return from the dialog component to the parent context.
        :type result: object
        :return: Value to return.
        :rtype: :class:`teams.dialogs.DialogTurnResult.result`
        """
