...
from teams.dialogs.choices import Choice, ListStyle
...
class PromptOptions:
    ...
    def __init__(
        ...
        """
        Sets the initial prompt to send to the user as an :class:`teams.schema.Activity`.

        :param prompt: The initial prompt to send to the user
        :type prompt: :class:`teams.schema.Activity`
        :param retry_prompt: The retry prompt to send to the user
        :type retry_prompt: :class:`teams.schema.Activity`
