...
class CaseInsensitiveDict(dict):
    ...
    def __setitem__(self, key, value):
        super(CaseInsensitiveDict, self).__setitem__(self.__class__._k(key),
                                                     value)
    ...
    def pop(self, key, *args, **kwargs):
        return super(CaseInsensitiveDict, self).pop(self.__class__._k(key),
                                                    *args, **kwargs)

    def get(self, key, *args, **kwargs):
        return super(CaseInsensitiveDict, self).get(self.__class__._k(key),
                                                    *args, **kwargs)
...
class TurnMemoryScope(MemoryScope):
    ...
    def get_memory(self, dialog_context: "DialogContext") -> object:
        ...
        turn_value = dialog_context.context.turn_state.get(
            scope_path.TURN, None)
