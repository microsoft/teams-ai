...
class TaskModuleRequest(Model):
    ...
    :type context:
     ~teams.connector.teams.models.TaskModuleRequestContext
    :param tab_entity_context: Gets or sets current tab request context.
    :type tab_entity_context:
     ~teams.connector.teams.models.TabEntityContext
    """
...
class ConversationList(Model):
    ...
    :param conversations:
    :type conversations:
     list[~teams.connector.teams.models.ChannelInfo]
    """
...
class FileConsentCardResponse(Model):
    ...
    :type upload_info: ~teams.connector.teams.models.FileUploadInfo
    """
...
class MessageActionsPayloadApp(Model):
    ...
    :type application_identity_type: str or
     ~teams.connector.teams.models.enum
...
class MessageActionsPayloadFrom(Model):
    ...
    :type user: ~teams.connector.teams.models.MessageActionsPayloadUser
    :param application: Represents details of the app.
    :type application:
     ~teams.connector.teams.models.MessageActionsPayloadApp
    :param conversation: Represents details of the converesation.
    :type conversation:
     ~teams.connector.teams.models.MessageActionsPayloadConversation
    """
...
class MessageActionsPayloadMention(Model):
    ...
    :type mentioned:
     ~teams.connector.teams.models.MessageActionsPayloadFrom
    """
...
class MessageActionsPayloadReaction(Model):
    ...
    :type user: ~teams.connector.teams.models.MessageActionsPayloadFrom
    """
...
class MessageActionsPayload(Model):
    ...
    :type body: ~teams.connector.teams.models.MessageActionsPayloadBody
    ...
    :type attachments:
     list[~teams.connector.teams.models.MessageActionsPayloadAttachment]
    :param mentions: List of entities mentioned in the message.
    :type mentions:
     list[~teams.connector.teams.models.MessageActionsPayloadMention]
    :param reactions: Reactions for the message.
    :type reactions:
     list[~teams.connector.teams.models.MessageActionsPayloadReaction]
    """
...
class MessagingExtensionAction(TaskModuleRequest):
    ...
    :type bot_activity_preview:
     list[~teams.schema.models.Activity]
    :param message_payload: Message content sent as part of the command
     request.
    :type message_payload:
     ~teams.connector.teams.models.MessageActionsPayload
    """
...
class MessagingExtensionActionResponse(Model):
    ...
    :type task: ~teams.connector.teams.models.TaskModuleResponseBase
    :param compose_extension:
    :type compose_extension:
     ~teams.connector.teams.models.MessagingExtensionResult
    :param cache_info: CacheInfo for this MessagingExtensionActionResponse.
    :type cache_info: ~teams.connector.teams.models.CacheInfo
    """
...
class MessagingExtensionAttachment(Attachment):
    ...
    :type thumbnail_url: str
    :param preview:
    :type preview: ~teams.connector.teams.models.Attachment
    """
...
class MessagingExtensionQuery(Model):
    ...
    :type parameters:
     list[~teams.connector.teams.models.MessagingExtensionParameter]
    :param query_options:
    :type query_options:
     ~teams.connector.teams.models.MessagingExtensionQueryOptions
...
class MessagingExtensionResponse(Model):
    ...
    :param compose_extension:
    :type compose_extension: ~teams.connector.teams.models.MessagingExtensionResult
...
class MessagingExtensionResult(Model):
    ...
    :type attachments:
     list[~teams.connector.teams.models.MessagingExtensionAttachment]
    :param suggested_actions:
    :type suggested_actions:
     ~teams.connector.teams.models.MessagingExtensionSuggestedAction
    :param text: (Only when type is message) Text
    :type text: str
    :param activity_preview: (Only when type is botMessagePreview) Message
     activity to preview
    :type activity_preview: ~teams.connector.teams.models.Activity
    """
...
class MessagingExtensionSuggestedAction(Model):
    ...
    :type actions: list[~teams.connector.teams.models.CardAction]
    """
...
class O365ConnectorCard(Model):
    ...
    :type sections:
     list[~teams.connector.teams.models.O365ConnectorCardSection]
    :param potential_action: Set of actions for the current card
    :type potential_action:
     list[~teams.connector.teams.models.O365ConnectorCardActionBase]
    """
...
class O365ConnectorCardActionCard(O365ConnectorCardActionBase):
    ...
    :type inputs:
     list[~teams.connector.teams.models.O365ConnectorCardInputBase]
...
class O365ConnectorCardMultichoiceInput(O365ConnectorCardInputBase):
    ...
    :type choices:
     list[~teams.connector.teams.models.O365ConnectorCardMultichoiceInputChoice]
...
class O365ConnectorCardOpenUri(O365ConnectorCardActionBase):
    ...
    :type targets:
     list[~teams.connector.teams.models.O365ConnectorCardOpenUriTarget]
    """
...
class O365ConnectorCardSection(Model):
    ...
    :type facts:
     list[~teams.connector.teams.models.O365ConnectorCardFact]
    :param images: Set of images for the current section
    :type images:
     list[~teams.connector.teams.models.O365ConnectorCardImage]
...
class TaskModuleContinueResponse(TaskModuleResponseBase):
    ...
    :type value: ~teams.connector.teams.models.TaskModuleTaskInfo
    """
...
class TaskModuleTaskInfo(Model):
    ...
    :type card: ~teams.connector.teams.models.Attachment
...
class TeamsPagedMembersResult(PagedMembersResult):
    ...
    :type members: list[~teams.connector.models.TeamsChannelAccount]
    """
...
class TabRequest(Model):
    ...
    :type context:
     ~teams.connector.teams.models.TabContext
...
class TabResponseCards(Model):
    ...
    :type cards:
    list[ ~teams.connector.teams.models.TabResponseCard]
    """
...
class TabResponse(Model):
    ...
    :type type: ~teams.connector.teams.models.TabResponsePayload
    """
...
class TabSumit(Model):
    ...
    :type data:
     ~teams.connector.teams.models.TabSubmitData
    """
...
class TabSubmit(Model):
    ...
    :param tab_entity_context: Gets or sets current tab entity request context.
    :type tab_entity_context: ~teams.connector.teams.models.TabEntityContext
    :param context: Gets or sets current user context, i.e., the current theme.
    :type context: ~teams.connector.teams.models.TabContext
    :param data: User input data. Free payload containing properties of key-value pairs.
    :type data: ~teams.connector.teams.models.TabSubmitData
    """
...
class TabSuggestedActions(Model):
    ...
    :type actions: list[~teams.connector.models.CardAction]
    """
...
class TaskModuleCardResponse(TaskModuleResponseBase):
    ...
    :type value: ~teams.connector.teams.models.TabResponse
    """
...
class MeetingInfo(Model):
    ...
    :type details: ~teams.connector.teams.models.MeetingDetails
    :param conversation: The Conversation Account for the meeting.
    :type conversation: ~teams.schema.models.ConversationAccount
    :param organizer: The meeting's scheduled start time, in UTC.
    :type organizer: ~teams.schema.models.TeamsChannelAccount
    """
