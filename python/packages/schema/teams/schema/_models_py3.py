...
from teams.schema._connector_client_enums import ActivityTypes
...
class ConversationReference(Model):
    ...
    :type user: ~teams.connector.models.ChannelAccount
    :param bot: Bot participating in this conversation
    :type bot: ~teams.connector.models.ChannelAccount
    :param conversation: Conversation reference
    :type conversation: ~teams.connector.models.ConversationAccount
...
class Mention(Model):
    ...
    :type mentioned: ~teams.connector.models.ChannelAccount
...
class Activity(Model):
    ...
    :param type: Contains the activity type. Possible values include:
     ...
     'trace', 'handoff'
    :type type: str or ~teams.connector.models.ActivityTypes
    ...
    :type from_property: ~teams.connector.models.ChannelAccount
    ...
    :type recipient: ~teams.connector.models.ChannelAccount
    :param text_format: Format of text fields Default:markdown. Possible
     values include: 'markdown', 'plain', 'xml'
    :type text_format: str or ~teams.connector.models.TextFormatTypes
    ...
    :param input_hint: Indicates whether your bot is accepting,
     ...
     'expectingInput'
    :type input_hint: str or ~teams.connector.models.InputHints
    ...
    :type suggested_actions: ~teams.connector.models.SuggestedActions
    :param attachments: Attachments
    :type attachments: list[~teams.connector.models.Attachment]
    :param entities: Represents the entities that were mentioned in the
     message.
    :type entities: list[~teams.connector.models.Entity]
    ...
    :type relates_to: ~teams.connector.models.ConversationReference
    ...
    :type code: str or ~teams.connector.models.EndOfConversationCodes
    ...
    :type importance: str or ~teams.connector.models.ActivityImportance
    ...
    :type delivery_mode: str or ~teams.connector.models.DeliveryModes
    ...
    :type text_highlights: list[~teams.connector.models.TextHighlight]
    :param semantic_action: An optional programmatic action accompanying this
     request
    :type semantic_action: ~teams.connector.models.SemanticAction
    ...
    def apply_conversation_reference(self,
    ...
    def as_contact_relation_update_activity(self):
        ...
        """
        return (self if self.__is_activity(
            ActivityTypes.contact_relation_update) else None)
    ...
    def as_conversation_update_activity(self):
        ...
        """
        return self if self.__is_activity(
            ActivityTypes.conversation_update) else None
    ...
    def as_end_of_conversation_activity(self):
        ...
        """
        return self if self.__is_activity(
            ActivityTypes.end_of_conversation) else None
    ...
    def as_installation_update_activity(self):
        ...
        """
        return self if self.__is_activity(
            ActivityTypes.installation_update) else None
    ...
    def as_message_delete_activity(self):
        ...
        """
        return self if self.__is_activity(
            ActivityTypes.message_delete) else None
    ...
    def as_message_reaction_activity(self):
        ...
        """
        return self if self.__is_activity(
            ActivityTypes.message_reaction) else None
    ...
    def as_message_update_activity(self):
        ...
        """
        return self if self.__is_activity(
            ActivityTypes.message_update) else None
    ...
    @staticmethod
    def create_trace_activity(name: str,
                              value: object = None,
                              value_type: str = None,
                              label: str = None):
        """
    ...
    def get_reply_conversation_reference(
            self, reply: ResourceResponse) -> ConversationReference:
        """
...
class AnimationCard(Model):
    ...
    :type image: ~teams.connector.models.ThumbnailUrl
    ...
    :type media: list[~teams.connector.models.MediaUrl]
    :param buttons: Actions on this card
    :type buttons: list[~teams.connector.models.CardAction]
...
class AttachmentInfo(Model):
    ...
    :type views: list[~teams.connector.models.AttachmentView]
    """
...
class BasicCard(Model):
    ...
    :type images: list[~teams.connector.models.CardImage]
    ...
    :param tap: This action will be activated when user taps on the card
     itself
    :type tap: ~teams.connector.models.CardAction
    """
...
class CardAction(Model):
    ...
    :type type: str or ~teams.connector.models.ActionTypes
...
class ChannelAccount(Model):
    ...
    :type role: str or ~teams.connector.models.RoleTypes
    """
...
class ConversationMembers(Model):
    ...
    :type members: list[~teams.connector.models.ChannelAccount]
    """
...
class ConversationParameters(Model):
    ...
    :type activity: ~teams.connector.models.Activity
...
class ConversationsResult(Model):
    ...
    :type conversations:
     list[~teams.connector.models.ConversationMembers]
    """
...
class ExpectedReplies(Model):
    ...
    :type activities: list[~teams.connector.models.Activity]
    """
...
class Error(Model):
    ...
    :type inner_http_error: ~teams.connector.models.InnerHttpError
    """
...
class ErrorResponse(Model):
    ...
    :type error: ~teams.connector.models.Error
    """
...
class MessageReaction(Model):
    ...
    :param type: Message reaction type. Possible values include: 'like',
     'plusOne'
    :type type: str or ~teams.connector.models.MessageReactionTypes
    """
...
class ReceiptCard(Model):
    ...
    :type facts: list[~teams.connector.models.Fact]
    :param items: Array of Receipt Items
    :type items: list[~teams.connector.models.ReceiptItem]
    :param tap: This action will be activated when user taps on the card
    :type tap: ~teams.connector.models.CardAction
...
class ReceiptItem(Model):
    ...
    :type text: str
    :param image: Image
    :type image: ~teams.connector.models.CardImage
...
class SemanticAction(Model):
    ...
    :type entities: dict[str, ~teams.connector.models.Entity]
    :param state: State of this action. Allowed values: `start`, `continue`, `done`
    :type state: str or ~teams.connector.models.SemanticActionStates
    """
...
class TokenExchangeState(Model):
    ...
    :type conversation: ~teams.connector.models.ConversationReference
...
class AdaptiveCardInvokeValue(Model):
    ...
    :type action: :class:`teams.schema.models.AdaptiveCardInvokeAction`
    :param authentication: The TokenExchangeInvokeRequest for this adaptive card invoke action value.
    :type authentication: :class:`teams.schema.models.TokenExchangeInvokeRequest`
