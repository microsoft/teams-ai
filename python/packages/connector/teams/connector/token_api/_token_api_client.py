...
class TokenApiClient(SDKClient):
    ...
    :vartype bot_sign_in: teams.tokenapi.operations.BotSignInOperations
    :ivar user_token: UserToken operations
    :vartype user_token: teams.tokenapi.operations.UserTokenOperations
    ...
    def __init__(self, credentials, base_url=None):
        ...
        super(TokenApiClient, self).__init__(self.config.credentials,
                                             self.config)
