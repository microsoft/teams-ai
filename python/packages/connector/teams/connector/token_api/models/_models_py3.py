...
class Error(Model):
    ...
    :type inner_http_error: ~teams.tokenapi.models.InnerHttpError
    """
...
class ErrorResponse(Model):
    ...
    :param error:
    :type error: ~teams.tokenapi.models.Error
    """
...
class SignInUrlResponse(Model):
    ...
    :type token_exchange_resource:
     ~teams.tokenapi.models.TokenExchangeResource
    """
    ...
    def __init__(self, *, sign_in_link: str = None, token_exchange_resource=None, **kwargs) -> None:
