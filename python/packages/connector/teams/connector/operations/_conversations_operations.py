...
class ConversationsOperations:
    ...
    def get_conversations(self, continuation_token=None, custom_headers=None, raw=False, **operation_config):
        """GetConversations.
        ...
        :rtype: ~teams.connector.models.ConversationsResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<teams.connector.models.ErrorResponseException>`
        """
        # Construct URL
    ...
    def create_conversation(self, parameters, custom_headers=None, raw=False, **operation_config):
        """CreateConversation.
        ...
        * Array containing the members to include in the conversation
        ...
        :type parameters:
         ~teams.connector.models.ConversationParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :rtype: ~teams.connector.models.ConversationResourceResponse or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<teams.connector.models.ErrorResponseException>`
        """
    ...
    def send_to_conversation(self, conversation_id, activity, custom_headers=None, raw=False, **operation_config):
        """SendToConversation.
        ...
        * ReplyToActivity(conversationId,ActivityId) - adds the activity as a
        ...
        :rtype: ~teams.connector.models.ResourceResponse or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<teams.connector.models.ErrorResponseException>`
        """
    ...
    def get_conversation_members(self, conversation_id, custom_headers=None, raw=False, **operation_config):
        ...
        :rtype: list[~teams.connector.models.ChannelAccount] or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<teams.connector.models.ErrorResponseException>`
        """
    ...
    def get_conversation_member(self, conversation_id, member_id, custom_headers=None, raw=False, **operation_config):
    ...
    get_conversation_member.metadata = {"url": "/v3/conversations/{conversationId}/members/{memberId}"}
    ...
    def get_conversation_paged_members(
        ...
        **operation_config,
        ...
        :rtype: ~teams.connector.models.PagedMembersResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
    ...
    def get_activity_members(self, conversation_id, activity_id, custom_headers=None, raw=False, **operation_config):
        """GetActivityMembers.
    ...
    def upload_attachment(self, conversation_id, attachment_upload, custom_headers=None, raw=False, **operation_config):
        """UploadAttachment.
        ...
        :type attachment_upload: ~teams.connector.models.AttachmentData
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
