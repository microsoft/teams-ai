...
class GovernmentChannelValidation(ABC):
    ...
    async def authenticate_channel_token(
        ...
        endpoint = (
            ...
            if GovernmentChannelValidation.OPEN_ID_METADATA_ENDPOINT else
            GovernmentConstants.TO_BOT_FROM_CHANNEL_OPEN_ID_METADATA_URL)
        token_extractor = JwtTokenExtractor(
            GovernmentChannelValidation.
            TO_BOT_FROM_GOVERNMENT_CHANNEL_TOKEN_VALIDATION_PARAMETERS,
            endpoint,
