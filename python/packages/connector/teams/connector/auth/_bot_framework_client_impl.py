...
class _BotFrameworkClientImpl(BotFrameworkClient):
    ...
    async def post_activity(
        ...
        request = HttpRequest(request_uri=to_url, content=json_content, headers=headers_dict)
        ...
        return InvokeResponse(status=response.status_code, body=loads(data) if data else None)
