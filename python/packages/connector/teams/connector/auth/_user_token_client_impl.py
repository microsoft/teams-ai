...
class _UserTokenClientImpl(UserTokenClient):
    ...
    async def get_sign_in_resource(
        ...
        result = await self._client.bot_sign_in.get_sign_in_resource(
            UserTokenClient.create_token_exchange_state(self._app_id, connection_name, activity),
    ...
    async def get_token_status(self, user_id: str, channel_id: str, include_filter: str) -> List[TokenStatus]:
        ...
        result = await self._client.user_token.get_token_status(user_id, channel_id, include_filter)
