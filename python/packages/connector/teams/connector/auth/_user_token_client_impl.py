...
from teams.schema import Activity, TokenResponse

from teams.connector.token_api import TokenApiClientConfiguration
from teams.connector.token_api.aio import TokenApiClient
...
class _UserTokenClientImpl(UserTokenClient):
    ...
    async def get_user_token(self, user_id: str, connection_name: str,
        ...
        result = await self._client.user_token.get_token(user_id,
                                                         connection_name,
    ...
    async def sign_out_user(self, user_id: str, connection_name: str,
        ...
        await self._client.user_token.sign_out(user_id, connection_name,
                                               channel_id)
    ...
    async def exchange_token(
        ...
        (uri, token) = ((exchange_request.uri,
                         exchange_request.token) if exchange_request else
                        (None, None))
