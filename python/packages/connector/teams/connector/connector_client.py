...
class ConnectorClient(SDKClient):
    ...
    * Generate your own from the
    ...
    :vartype attachments: teams.connector.operations.AttachmentsOperations
    :ivar conversations: Conversations operations
    :vartype conversations: teams.connector.operations.ConversationsOperations
    ...
    def __init__(self, credentials, base_url=None):
        ...
        super(ConnectorClient, self).__init__(self.config.credentials,
                                              self.config)
