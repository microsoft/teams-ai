...
class ConversationsOperations:
    ...
    async def get_conversations(self, continuation_token=None, *, custom_headers=None, raw=False, **operation_config):
        """GetConversations.
    ...
    async def create_conversation(self, parameters, *, custom_headers=None, raw=False, **operation_config):
        """CreateConversation.
    ...
    async def get_conversation_members(self, conversation_id, *, custom_headers=None, raw=False, **operation_config):
