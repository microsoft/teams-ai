...
class ConnectorClient(BotFrameworkSDKClientAsync):
    ...
    * Generate your own from the
    ...
    :vartype attachments: teams.connector.aio.operations_async.AttachmentsOperations
    :ivar conversations: Conversations operations
    :vartype conversations: teams.connector.aio.operations_async.ConversationsOperations
