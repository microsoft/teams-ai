...
class TeamsOperations(object):
    ...
    def get_teams_channels(self, team_id, custom_headers=None, raw=False, **operation_config):
        ...
        :rtype: ~teams.connector.teams.models.ConversationList or
    ...
    def get_team_details(self, team_id, custom_headers=None, raw=False, **operation_config):
        ...
        :rtype: ~teams.connector.teams.models.TeamDetails or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`HttpOperationError<msrest.exceptions.HttpOperationError>`
        """
    ...
    def fetch_participant(
        ...
        **operation_config,
        ...
        :rtype: ~teams.connector.teams.models.TeamsParticipantChannelAccount or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`HttpOperationError<msrest.exceptions.HttpOperationError>`
        """
    ...
    fetch_participant.metadata = {"url": "/v1/meetings/{meetingId}/participants/{participantId}?tenantId={tenantId}"}
    ...
    def fetch_meeting(self, meeting_id: str, custom_headers=None, raw=False, **operation_config):
        ...
        :rtype: ~teams.connector.teams.models.MeetingInfo or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`HttpOperationError<msrest.exceptions.HttpOperationError>`
        """
