...
class TestAdapter(BotAdapter, ExtendedUserTokenProvider):
    ...
    async def process_activity(self, activity: Activity, logic: Callable[[TurnContext], Awaitable]):
    ...
    async def send_activities(self, context, activities: List[Activity]) -> List[ResourceResponse]:
        """
