...
from teams.schema import Activity, ConversationReference, ResourceResponse
...
class BotAdapter(ABC):
    ...
    BOT_OAUTH_SCOPE_KEY = "teams.core.BotAdapter.OAuthScope"
    ...
    async def continue_conversation(
        ...
        :param claims_identity: A :class:`teams.connector.auth.ClaimsIdentity` for the conversation.
