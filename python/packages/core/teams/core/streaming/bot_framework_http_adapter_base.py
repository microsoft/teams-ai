...
from teams.schema import Activity, ActivityTypes, ResourceResponse
from teams.connector import AsyncBfPipeline, BotFrameworkConnectorConfiguration
...
class BotFrameworkHttpAdapterBase(BotFrameworkAdapter, StreamingActivityProcessor):
    ...
    async def process_streaming_activity(
        ...
        connector_client = self._create_streaming_connector_client(activity, request_handler)
