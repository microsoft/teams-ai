...
from teams.core import Bot
from teams.schema import Activity, Attachment, ResourceResponse
...
from teams.streaming.transport.web_socket import WebSocket, WebSocketServer
