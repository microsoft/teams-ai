...
class CardFactory:
    ...
    def audio_card(card: AudioCard) -> Attachment:
        ...
        return Attachment(content_type=CardFactory.content_types.audio_card, content=card)
    ...
    def hero_card(card: HeroCard) -> Attachment:
        ...
        return Attachment(content_type=CardFactory.content_types.hero_card, content=card)
    ...
    def oauth_card(card: OAuthCard) -> Attachment:
        ...
        return Attachment(content_type=CardFactory.content_types.oauth_card, content=card)
    ...
    def receipt_card(card: ReceiptCard) -> Attachment:
        ...
        return Attachment(content_type=CardFactory.content_types.receipt_card, content=card)
    ...
    def thumbnail_card(card: ThumbnailCard) -> Attachment:
        ...
        return Attachment(content_type=CardFactory.content_types.thumbnail_card, content=card)
    ...
    def video_card(card: VideoCard) -> Attachment:
        ...
        return Attachment(content_type=CardFactory.content_types.video_card, content=card)
