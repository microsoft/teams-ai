...
from teams.core import Bot, BotAdapter, TurnContext
...
class _SkillHandlerImpl(SkillHandler):
    ...
    @staticmethod
    def _apply_skill_activity_to_turn_context_activity(context: TurnContext, activity: Activity):
    ...
    async def _process_activity(
        ...
        async def callback(context: TurnContext):
            ...
            context.activity.caller_id = f"{CallerIdConstants.bot_to_bot_prefix}{app_id}"

            if activity.type == ActivityTypes.end_of_conversation:
                await self._conversation_id_factory.delete_conversation_reference(conversation_id)
    ...
    async def _send_to_bot(self, activity: Activity, context: TurnContext):
        _SkillHandlerImpl._apply_skill_activity_to_turn_context_activity(context, activity)
