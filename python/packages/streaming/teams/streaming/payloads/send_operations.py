...
from teams.streaming.payloads.disassemblers import (
    CancelDisassembler,
    RequestDisassembler,
...
class SendOperations:
    ...
    async def send_request(self, identifier: UUID, request: "streaming.StreamingRequest"):
    ...
    async def send_response(self, identifier: UUID, response: "streaming.StreamingResponse"):
