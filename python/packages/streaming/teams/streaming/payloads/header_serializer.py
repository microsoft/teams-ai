...
class HeaderSerializer:
    ...
    def serialize(
        ...
        # write type
        buffer[HeaderSerializer.TYPE_OFFSET] = HeaderSerializer._char_to_binary_int(header.type)
        ...
        # write id
        id_binary_array: List[int] = list(HeaderSerializer._uuid_to_numeric_encoded_str(header.id))
        HeaderSerializer._write_in_buffer(id_binary_array, buffer, HeaderSerializer.ID_OFFSET)
    ...
    def deserialize(
        ...
        if buffer[HeaderSerializer.LENGTH_DELIMETER_OFFSET] != HeaderSerializer.DELIMITER:
