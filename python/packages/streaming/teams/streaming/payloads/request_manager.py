...
class RequestManager:
    def __init__(self, *, pending_requests: Dict[UUID, "Future[streaming.ReceiveResponse]"] = None):
        self._pending_requests = pending_requests or {}

    async def signal_response(self, request_id: UUID, response: "streaming.ReceiveResponse") -> bool:
