...
from teams.streaming import PayloadStream
from teams.streaming.payload_transport import PayloadReceiver
from teams.streaming.transport import TransportReceiverBase
...
class TestteamsHttpClient(aiounittest.AsyncTestCase):
