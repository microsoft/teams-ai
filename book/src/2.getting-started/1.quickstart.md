...
> [!NOTE]
>
> _The [Teams CLI](../7.developer-tools/1.cli/README.md) is a command-line tool that helps you create and manage Teams applications. It provides a set of commands to simplify the development process._<br><br>
