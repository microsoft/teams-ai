...
Teams Toolkit is a powerful tool that simplifies deploying and debugging Teams applications. It automates tasks like managing the Teams app manifest, configuring authentication, provisioning, and deployment.
...
> [!NOTE]<br/>
> The Teams Toolkit extension makes it easy to debug and test your Teams applications directly in Microsoft Teams. If you'd like to learn what it helps automate, check out [Teams core concepts](../4.teams/1.core-concepts.md)
...
This command adds configuration files required by Teams Toolkit, including:
...
![Teams Toolkit local environment UI](teams-toolkit.png)
...
⚠️ Please note that TTK is not managed by the Teams AI team. For problems running TTK, please refer to the [Teams Toolkit documentation](https://learn.microsoft.com/en-us/microsoftteams/platform/toolkit/overview) or contact the [Teams Toolkit team](https://github.com/OfficeDev/Teams-Toolkit).
