...
> [!TIP]
> This shows an example of sending a text message. Additionally, you are able to send back things like [adaptive cards](../in-depth-guides/1.cards/) by using the same `send` method. Look at the [adaptive card](../5.in-depth-guides) section for more details.
