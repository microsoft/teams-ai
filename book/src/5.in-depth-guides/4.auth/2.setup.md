...
> [!Note]
> This is an advanced guide. It is highly recommended that you are familiar with [Teams Core Concepts](../../4.teams/1.core-concepts.md) before attempting this guide.


## Enable SSO to authenticate the user to Entra ID to access Microsoft Graph APIs
...
> [!Note]
> Single Sign-On (SSO) within Teams is an authentication method that uses an app user's Teams identity to provide them with access to your app. A user who has logged into Teams doesn't need to log in again to your app within the Teams environment.

### Manual setup

In this step you will have to tweak your Azure Bot service and App registration to enable Single Sign-On (SSO).
