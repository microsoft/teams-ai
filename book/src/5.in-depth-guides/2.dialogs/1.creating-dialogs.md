...
You can render a webpage in a dialog as well. There are some security requirements to be aware of here.

1. The webpage must be hosted on a domain that is allowlisted in the Teams app [manifest](../../4.teams/2.manifest.md) for the agent
