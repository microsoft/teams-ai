...
```ts
{{#include ../../../../generated-snippets/ts/server-example.snippet.a2a-server-app-initialization-example.ts }}
```
...
```ts
{{ #include ../../../../generated-snippets/ts/server-example.snippet.a2a-server-event-handler-example.ts }}
```
