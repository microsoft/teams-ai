...
> [!CAUTION]
> Teams Toolkit CLI is not to be confused with the [Teams AI v2 library CLI](../developer-tools/1.cli/), which is managed by our team.
...
- [Teams AI v2 CLI documentation](./(developer-tools)/1.cli/README.md) - includes instructions on adding toolkit configurations to your Teams AI v2 agent.
