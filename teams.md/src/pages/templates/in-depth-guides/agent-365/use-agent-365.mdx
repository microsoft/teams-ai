...
A proactive operation has no inbound activity that identifies the sender. Create or restore the `AgenticUser`, then pass it as the `AgenticIdentity` operation scope.
