...
Once you have deployed a model, include the following keys and values in your `.env` file:
...
Once you have your API key, include the following key and value in your `.env` file:
