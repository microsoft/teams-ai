...
8. You should be prompted to sideload a bot into teams. Click the `Add` button to load the app in Teams.
   ...
   ![add echobot](C:\Users\kavinsingh\source\repos\teams-ai-test\new-getting-started\assets\quickstart-echobot-add.png)

9. This should redirect you to a chat window with the bot.
   
   ![demo echobot](C:\Users\kavinsingh\source\repos\teams-ai-test\new-getting-started\assets\quickstart-echobot-demo.png)
